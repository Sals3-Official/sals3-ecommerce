...
**Where applied:** `Sals3CategoryPicker.tsx`'s compact-view "Change" button carries both `id="editor-sals3-category-v1"` (label association) and `aria-label="Change category"` (accessible name). See [[sals3-session-2026-08-15-part47-taxonomy-v1-production-rollout-and-category-picker-ux]].
