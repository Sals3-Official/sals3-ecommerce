...
- Session records for parts 143-159 (2026-09-07/08, 67 substantive merged pull requests across four repositories) are listed with one-line summaries under *Recent session notes* in [[hot]], the chronological home for every wiki session note. Engineering lessons drawn from them are skills 76-101 in [[sals3-skills]].
