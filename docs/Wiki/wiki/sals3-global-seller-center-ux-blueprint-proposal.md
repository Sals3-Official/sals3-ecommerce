...
- **Gap #3 (overlap with [[sals3-cj-dropshipping-integration-plan]] / [[ADR-001-seller-center-cj-sourcing-to-my-products]])** is unresolved by this build — the new-listing wizard is a read-only preview of what a filled listing looks like, not the real CJ-sourcing-to-My-Products flow ADR-001 designs. Reconcile before either is built for real.
